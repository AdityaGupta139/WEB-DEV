        ...
        <>
            ...
            <div className='container mx-auto py-5 px-6 '>
                ...
                <form className="max-w-2xl mx-auto" action={handleSubmit}>
                    ...
                    {/* Submit Button  */}
                    <div className="my-6">
                        <button type="submit" className="text-white w-full bg-gradient-to-br from-pink-600 to-fuchsia-500 hover:from-fuchsia-500 hover:to-pink-600 focus:ring-2 focus:ring-pink-500/30 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 shadow-lg shadow-pink-500/10 transition-all duration-200 hover:cursor-pointer">Save</button>
                    </div>
                </form>
